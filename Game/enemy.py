...
class Enemy:
    ...
    def __init__(self,name="Enemy", hit_points=0, lives=1, base_hp=0):
        self._name = name
    ...
    def take_damage(self, damage):
        ...
        if remaining_points > 1:
            ...
            print("It took {} points damage and have {} left".format(damage, self._hit_points))
        else:
            self._lives -= 1
            if self._lives != 0:
                self._hit_points = self.base_hp
            if self._lives > 0:
...
class Troll(Enemy):
    ...
    def __init__(self, name):
        super().__init__(name=name, lives=1, hit_points=23, base_hp=23)
...
class Vampire(Enemy):
    ...
    def __init__(self, name):
        super(Vampire, self).__init__(name=name, lives=3, hit_points=12, base_hp=12)
